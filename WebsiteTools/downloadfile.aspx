...
*/
    ...
    public static string GetMD5Hash(System.IO.Stream inputStream)
    {
        ...
        System.Security.Cryptography.MD5 md5Hasher = System.Security.Cryptography.MD5.Create();//不可逆转 
    ...
    /// <returns></returns> 
    public static bool VerifyMD5Hash(System.IO.Stream inputStream, string hash)
    {
    ...
    /// </summary>
    /// <param name="httpContext">当前请求的 HttpContext。（一般取值为 this.Context）</param>
    /// <param name="filePath">下载文件的物理路径，含路径、文件名</param>
    /// <param name="speed">下载速度：每秒允许下载的字节数。（取值为 -1 表示不限制下载速度。）</param>
    ...
    public static bool DownloadFile(HttpContext httpContext, string filePath, long speed)
    {
        ...
        try
        {
            ...
            System.IO.FileStream myFile = new System.IO.FileStream(filePath, System.IO.FileMode.Open, System.IO.FileAccess.Read, System.IO.FileShare.ReadWrite);
            System.IO.BinaryReader br = new System.IO.BinaryReader(myFile);
            long fileLength = myFile.Length;

            int sleep = (speed == -1 ? 0 : (int)Math.Ceiling(1000.0 * packSize / speed));//毫秒数：读取下一数据块的时间间隔
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DownloadFile(this.Context, (string.IsNullOrEmpty(this.Request["filename"]) ? "" : this.MapPath(this.Request["filename"])), -1);
